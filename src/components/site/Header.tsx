...
const NAV = [
  ...
  { to: "/commercial-expansion", label: "Commercial Expansion" },
...
export function Header() {
  ...
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-50 border-b border-[var(--rule)] bg-background/90 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6 lg:px-12">
          ...
          <div className="flex items-center gap-4 lg:gap-8">
              ...
              <ul className="flex items-center gap-6">
                {NAV.map((item) => (
                  <li key={item.to}>
                    <Link
                      to={item.to}
                      className="text-[11px] uppercase tracking-[0.14em] text-[var(--ink-soft)] transition-colors hover:text-[var(--ink)]"
            ...
            <Link
              to="/contact"
              className="hidden border border-[var(--ink)] bg-[var(--ink)] px-4 py-2 text-[10px] uppercase tracking-[0.18em] text-white transition-colors hover:bg-transparent hover:text-[var(--ink)] sm:inline-flex"
            >
      ...
      {open && (
        ...
        >
          <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between border-b border-white/10 px-6 lg:px-12">
